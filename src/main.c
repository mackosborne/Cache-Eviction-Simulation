...
int main(int argc, char **argv)
{
    ...
    // TODO: calculate the line size and number of sets.   ----------------------------- Mack Done
    int line_size = cache_size / cache_lines; // cache size / number of lines
    int sets = cache_lines / associativity; //number of lines / lines per set
